          ...
          modelBuilder.Entity<Claim>(e =>
            {
                ...
                e.Property(c => c.Amount).IsRequired().HasPrecision(18, 2);
                e.HasOne(c => c.Car).WithMany().HasForeignKey(c => c.CarId).OnDelete(DeleteBehavior.Cascade);
            });
            }
}
...
public static class SeedData
{
    public static void EnsureSeeded(AppDbContext db)
    {
        ...
        db.Policies.AddRange(
            ...
            new InsurancePolicy { CarId = car1.Id, Provider = "Groupama", StartDate = new DateOnly(2025,1,1), EndDate = new DateOnly(2030,03,22) }, // open-ended on purpose
